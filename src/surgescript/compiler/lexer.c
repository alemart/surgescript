...
/* keywords */
static surgescript_tokentype_t keyword[] = { SSTOK_TRUE, SSTOK_FALSE, SSTOK_NULL, SSTOK_OBJECT, SSTOK_STATE, SSTOK_FUN, SSTOK_RETURN, SSTOK_THIS, SSTOK_IF, SSTOK_ELSE, SSTOK_WHILE, SSTOK_FOR, SSTOK_FOREACH, SSTOK_IN, SSTOK_BREAK, SSTOK_CONTINUE, SSTOK_TYPEOF, SSTOK_PUBLIC, SSTOK_PRIVATE, SSTOK_PROTECTED, SSTOK_EXTENDS, SSTOK_IMPLEMENTS, SSTOK_INTERFACE, SSTOK_ABSTRACT, SSTOK_CLASS, SSTOK_PACKAGE, SSTOK_NAMESPACE, SSTOK_USING, SSTOK_TRY, SSTOK_CATCH, SSTOK_THROW, SSTOK_THROWS, SSTOK_GOTO, SSTOK_VOID, SSTOK_DO, SSTOK_SWITCH, SSTOK_CASE, SSTOK_DEFAULT, SSTOK_CONST, SSTOK_FINAL, SSTOK_VAR, SSTOK_LET, SSTOK_ASSERT, SSTOK_WAIT, SSTOK_YIELD, SSTOK_TIMEOUT, SSTOK_STATIC, SSTOK_SUPER, SSTOK_OF, SSTOK_IS, SSTOK_CALLER, SSTOK_READONLY, SSTOK_SIGNAL };
