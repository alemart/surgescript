...
sslib: runtime/sslib/sslib.h runtime/sslib/object.c runtime/sslib/array.c runtime/sslib/application.c runtime/sslib/system.c runtime/sslib/string.c runtime/sslib/number.c runtime/sslib/boolean.c runtime/sslib/console.c runtime/sslib/transform2d.c runtime/sslib/math.c runtime/sslib/dictionary.c runtime/sslib/time.c runtime/sslib/temp.c heap utils utf8
	...
	$(CC) $(CFLAGS) -c runtime/sslib/math.c -o sslib_math.o
	$(CC) $(CFLAGS) -c runtime/sslib/dictionary.c -o sslib_dictionary.o
	$(CC) $(CFLAGS) -c runtime/sslib/time.c -o sslib_time.o
	$(CC) $(CFLAGS) -c runtime/sslib/temp.c -o sslib_temp.o
	ar -cvq sslib.a sslib_object.o sslib_array.o sslib_application.o sslib_system.o sslib_string.o sslib_number.o sslib_boolean.o sslib_console.o sslib_transform2d.o sslib_math.o sslib_dictionary.o sslib_time.o sslib_temp.o
