...
struct surgescript_symboltable_t { int i; }; // FIXME;
...
typedef struct surgescript_nodecontext_t
{
    ...
    struct surgescript_symboltable_t* symbol_table;
    struct surgescript_program_t* program;
} surgescript_nodecontext_t;

/* node context constructor */
static inline surgescript_nodecontext_t nodecontext(const char* object_name, struct surgescript_symboltable_t* symbol_table, struct surgescript_program_t* program)
{
